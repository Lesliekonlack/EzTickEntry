...
<div class="navbar">
    ...
    <div class="nav-items">
        <a href="#" class="active">See Who Attended</a>
        <a href="mypastevents.php" > My Past Events </a>
...
<h1>See Who Attended Your Event "<?php echo htmlspecialchars($eventTitle); ?>"</h1>
<input type="text" id="searchInput" class="search-input" onkeyup="searchEvent()" placeholder="Search attendees by name, email, or Seat ID">`
...
<?php foreach ($groupedAttendees as $tierName => $attendees): ?>
    <div id="list-<?php echo htmlspecialchars($tierName); ?>" class="attendee-list" style="display:none;">
        ...
        <h3><?php echo htmlspecialchars($tierName); ?> Attendees (Total: <?php echo $totalAttendees; ?>)</h3>
                ...
                <?php foreach ($attendees as $attendee): ?>
                    ...
                    <tr>
                        ...
                        <?php if ($attendee['BookingStatusID'] == 2): ?>
                            <div style="display: flex; align-items: center; gap: 5px;"> <!-- Reduced gap between elements -->
