...
<div class="dashboard-content">
  ...
  <h2>Your Normal User Dashboard</h2>
    ...
    <a href="upcomingevents.php" class="card-link">
        ...
        <a href="MyTickets.php" class="card-link">
        <div class="card">
...
<div class="dashboard-content">
    <h1>Your Control Dashboard</h1>

        <!-- Payment Overview -->
        <a href="payementoverview.php" class="card-link">
            <div class="card">
